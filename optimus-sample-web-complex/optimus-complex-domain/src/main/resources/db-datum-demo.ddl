...
INSERT INTO e_platform_account (id_, username_, password_, nickname_, role_id_, group_id_, type_, salt_, deleted_, created_, updated_) VALUES
    (110110, 'test1', '$2a$08$Q.sEn3Ey190/Gh17GWoV.uJm0bayX3jNNR95CbFViSywzt/3fZppW', '运营1', 110, 110, 1, '*', 0, now(), now()),
    (210210, 'test2', '$2a$08$Q.sEn3Ey190/Gh17GWoV.uJm0bayX3jNNR95CbFViSywzt/3fZppW', '渠道1', 210, 210, 1, '*', 0, now(), now());
